...
<body>
    ...
    <h1 style="font-family: muli; font-size: 30px; margin-top: 100px; text-align: center;"> Add the New Event Group </h1>
    <div class="form">
        <form id="event_form" action="event_categories_php.php" method="post" enctype="multipart/form-data">
            ...
            <br>
            <input type="text" placeholder="Enter the Background Color" name="color" required />
            <br/>
            <input type="text" placeholder="Enter the Link of the Page" name="link" />
            <br/>
            <input type="text" placeholder="Enter the type either 1 or 2" name="type" />
            <br/>
